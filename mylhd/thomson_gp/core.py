...
class ThomsonGPCore:
    ...
    def __init__(self, 
                 shotNo: int=190600,filename :str = None, from_opendata:bool = True,iprint:bool = True):
    ...
    def set_kernel(self,ValName:str=None, KernelType:str = None, reff_scale:float = 0.1,time_scale:float = 0.1, time_cutoff:float = 1e-8, reff_cutoff:float = 1e-5):
        ...
        Ktt_low = LowRankPDM(self.Kernel(self.time_inp,self.time_inp,length=time_scale),cutoff=time_cutoff,iprint=False)
        Krr_low = LowRankPDM(self.Kernel(self.rho_vac,self.rho_vac,length=reff_scale),cutoff=reff_cutoff,iprint=False)
    ...
    def local_post_mean_function(self, ValName: str = None,function_kind:str='f', rho_vac_l: np.ndarray = None, timel: np.ndarray = None):
        """
...
#
    ...
    def pipeline_sigma_optimize(self,
            valName:str,
            time_scale:float,
            reff_scale:float,
            mu :float = -2,
